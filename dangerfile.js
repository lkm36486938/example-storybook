...
if (danger.github.pr.user.type !== 'Bot') {
  ...
  if (reviewersCount === 0) {
    ...
    warn(
      `${reviewersCount} 명의 리뷰어가 있군요. 훌륭합니다! 최소 한명의 리뷰어가 해당 리뷰를 리드해주셔야 해요! 잊지마세요!`,
    );
  }
  ...
  if (danger.github.pr.additions + danger.github.pr.deletions > bigPRThreshold) {
    ...
    markdown(
      '🤷‍♀️PR 사이즈가 상대적으로 커보입니다. 만약 PR의 여러 이슈 및 변화를 가지고 있다면, 각각의 PR로 나누는게 훨씬 더 빠르고 쉽게 리뷰를 할 수 있게 도와줘요.',
    );
  }
}
